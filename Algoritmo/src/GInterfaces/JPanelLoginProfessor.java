...
import GInterfaces.Professor.ProfessorMenuInterface;
...
public class JPanelLoginProfessor extends JPanel {
	 ...
	 * Create the panel.
	 */
	public JPanelLoginProfessor(ArrayList<Professor> arp, Main m) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					for(int i = 0; i < arp.size(); i++) {
						if(arp.get(i).authencate(matriculationInteger, passwordInterger)) {
							setVisible(false);
							
							ProfessorMenuInterface professorInterface = new ProfessorMenuInterface(arp.get(i));
