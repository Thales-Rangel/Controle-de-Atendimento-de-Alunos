...
import GInterfaces.Admin.AdminMenuInterface;
...
public class JPanelLoginAdmin extends JPanel {
	 ...
	 * Create the panel.
	 */
	public JPanelLoginAdmin(ArrayList<Admin> ara, Main m) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					for(int i = 0; i < ara.size(); i++) {
						if(ara.get(i).authencate(matriculationInteger, passwordInterger)) {
							setVisible(false);

							AdminMenuInterface adminInterface = new AdminMenuInterface();
